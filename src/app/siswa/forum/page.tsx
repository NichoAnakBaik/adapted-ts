  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center">
        ...
        <p className="text-gray-500 mb-8 max-w-md mx-auto">Pilih kelas di bawah ini untuk masuk ke ruang diskusi bersama pengajar dan teman sekelas Anda.</p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
          {enrollments.map((e) => (
            <Link key={e.class.id} href={`/siswa/forum/${e.class.id}`} className="block p-6 rounded-2xl border border-gray-200 hover:border-namsan-primary hover:shadow-md transition-all group">
